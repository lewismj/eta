...
set(lightgbm_native_root "${lightgbm_root}/native/test")

file(REMOVE_RECURSE "${FIXTURE_ROOT}")
file(MAKE_DIRECTORY
    "${lightgbm_src_root}/ml"
    "${lightgbm_native_root}"
    "${app_tests_root}")

get_filename_component(sidecar_name "${SIDECAR_BINARY}" NAME)
set(staged_sidecar "${lightgbm_native_root}/${sidecar_name}")
...
artifact = \"native/test/${sidecar_name}\"
...
[dependencies]
eta-lightgbm-sidecar = { path = \"../lightgbm\" }
")
...
version = \"0.1.0\"
source = \"root\"
dependencies = [\"eta-lightgbm-sidecar@0.1.0\"]
...
native_artifact_relpath = \"native/test/${sidecar_name}\"
