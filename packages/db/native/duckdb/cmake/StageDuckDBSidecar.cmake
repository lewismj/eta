...
if("${HOST_TARGET_TRIPLE}" STREQUAL "x86_64-pc-windows-msvc")
    set(artifact_relpath "native/amd64/libs/eta_duckdb.dll")
elseif("${HOST_TARGET_TRIPLE}" STREQUAL "x86_64-unknown-linux-gnu")
    set(artifact_relpath "native/amd64/libs/libeta_duckdb.so")
elseif("${HOST_TARGET_TRIPLE}" STREQUAL "x86_64-apple-darwin")
    set(artifact_relpath "native/amd64/libs/libeta_duckdb.dylib")
elseif("${HOST_TARGET_TRIPLE}" STREQUAL "aarch64-apple-darwin")
    set(artifact_relpath "native/arm64/libs/libeta_duckdb.dylib")
else()
    message(FATAL_ERROR
