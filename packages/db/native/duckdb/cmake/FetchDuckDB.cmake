...
function(eta_duckdb_fetch)
    ...
    # Some CMake/generator combinations still emit parent install scripts that
    # include DuckDB's sub-build install script unconditionally, even when
    # install rules are skipped for the fetched project.
    # Ensure that include target exists to keep super-build `cmake --install`
    # deterministic across platforms.
    set(_eta_duckdb_upstream_install_script "${duckdb_upstream_BINARY_DIR}/cmake_install.cmake")
    if(NOT EXISTS "${_eta_duckdb_upstream_install_script}")
        file(WRITE "${_eta_duckdb_upstream_install_script}"
            "# Autogenerated by Eta: DuckDB upstream install rules were skipped.\n")
    endif()
