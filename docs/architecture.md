...
|------------|-------------|------|
| `etac` | [`main_etac.cpp`](../eta/tools/compiler/src/eta/compiler/main_etac.cpp) | Ahead-of-time compiler — emits `.etac` bytecode |
| `etai` | [`main_etai.cpp`](../eta/tools/interpreter/src/eta/interpreter/main_etai.cpp) | File interpreter — loads prelude, runs `.eta` or `.etac` |
| `eta_repl` | [`main_repl.cpp`](../eta/tools/interpreter/src/eta/interpreter/main_repl.cpp) | Interactive REPL — incremental execution, shared state |
| `eta_lsp` | [`main_lsp.cpp`](../eta/tools/lsp/src/eta/lsp/main_lsp.cpp) | Language Server — JSON-RPC over stdio, publishes diagnostics |
| `eta_dap` | [`main_dap.cpp`](../eta/tools/dap/src/eta/dap/main_dap.cpp) | Debug Adapter — DAP over stdio (breakpoints, stepping, heap inspection) |
