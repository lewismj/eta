...
[<- Back to Language Guide](../language_guide.md) · [Reference](./reference/README.md)

This folder contains tutorial deep dives for Language Guide chapters.
Use it for concept-first explanations and small examples; use
[`guide/reference/`](./reference/README.md) for exact module APIs, tool
flags, and runtime internals.
