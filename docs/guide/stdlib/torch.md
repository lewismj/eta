...
[← Stdlib Reference](./README.md) · [Language Guide](../../language_guide.md) · [Detailed reference](../reference/torch.md)

libtorch bindings: tensors, neural-network modules, optimizers, and
device management.

> **Build flag:** Available only when Eta is built with `-DETA_BUILD_TORCH=ON`.
...
**Source:** [`stdlib/std/torch.eta`](../../../stdlib/std/torch.eta)
