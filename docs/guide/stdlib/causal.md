...
[← Stdlib Reference](./README.md) · [Language Guide](../../language_guide.md) · [Detailed reference](../reference/causal.md)
...
| `(do:adjustment-formula->string formula)` | Pretty-print an adjustment formula. |
...
| [std.causal.learn](./causal/learn.md) | Structure learning. |
| [std.causal.counterfactual](./causal/counterfactual.md) | Counterfactual queries. |
| [std.causal.mediation](./causal/mediation.md) | Natural direct/indirect effects. |
| [std.causal.transport](./causal/transport.md) | Transportability of effects. |
| [std.causal.admg](./causal/admg.md) | ADMG operations. |
| [std.causal.render](./causal/render.md) | Graph rendering. |

---

**Source:** [`stdlib/std/causal.eta`](../../../stdlib/std/causal.eta)
