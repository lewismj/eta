...
[Causal Reference](causal.md) · [Portfolio Engine](portfolio.md) ·
...
> control — read [`portfolio.md`](portfolio.md) next.
...
> See [`portfolio.md`](portfolio.md) for the same `clp(R)` machinery
...
> See [`portfolio.md`](portfolio.md) for the same NN architecture
...
| A 6-node macro DAG, AAD sensitivities, QP, stress, dynamic control | [`portfolio.md`](portfolio.md)           |
